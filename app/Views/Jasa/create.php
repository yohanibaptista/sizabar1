...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- Form Tambah Layanan -->
                <form action="<?= base_url('jasa/create') ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="mb-3 row">
                        <label for="layanan" class="col-sm-2 col-form-label">Layanan</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('layanan') ? 'is-invalid' : '' ?>" id="layanan" name="layanan" value="<?= old('layanan') ?>">
